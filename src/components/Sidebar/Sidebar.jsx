...
export const Sidebar = () => {
  return (
    <div className='sidebar-container'>
      ...
      <span className='sidebar-datewise d-flex j-center dir-col pad-s'>Sorting Order
      ...
      <span className='sidebar-cateorywise d-flex j-center dir-col pad-s'>Category
      ...
      <span className='sidebar-prioritywise d-flex j-center dir-col pad'>Priority
